  ...
  <div class="category-list-wrapper">
    <div class="category-list">
      ...
      <ul>
        ...
        <li><a href="<?php echo $categories[$i]['href']; ?>"><span><?php echo $categories[$i]['name']; ?></span><br><img src="<?php echo $categories[$i]['thumb']; ?>"><br><?php echo $categories[$i]['desc']; ?></a></li>
        <?php } ?>
        <?php } ?>
      </ul>
      <?php } ?>
  ...
  <div class="product-list">
    ...
    <div class="product-list-wrapper">
      ...
      <?php if($product['attribute_groups']) { ?>
        <table width="100%" style="border-color: #fafafa; border-style: solid; border-width: 1px; border-collapse: collapse;">
        ...
        <tbody>
          <tr>
            ...
            <td>В наличии</td>
            <td>Количество: <input type="text" name="quantity" size="2" value="1"></td>
    ...
    <div class="compare-wrapper">
      ...
      <div class="compare-wrapper-description">Добавить товар:</div>
    </div>
    <?php } ?>
  </div>
