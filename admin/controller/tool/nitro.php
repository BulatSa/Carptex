...
class ControllerToolNitro extends Controller { 
	...
	public function index() {
		...
		if(file_exists(DIR_SYSTEM.'nitro/data/googlepagespeed.tpl') && !is_writable(DIR_SYSTEM.'nitro/data/googlepagespeed.tpl')) {
		...
		$this->data['widget']['pagespeed'] = $this->model_tool_nitro->getGooglePageSpeedReport();
