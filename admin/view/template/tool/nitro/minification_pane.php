         ...
         <div class="tab-content">
         	<div id="mini-css" class="tab-pane active">
                <table class="form minification" style="margin-top:-10px;">
                  ...
                  <tr>
                    <td style="vertical-align:top;">Excluded files<span class="help">Each file on a new line. The files you specify here will be excluded from minification.</span></td>
